...
const draftWithEntry = JSON.stringify({
  entries: [{
    ...
    land: 'Nederland', colli: 1, colliOmschrijvingen: ['Test omschrijving'], recipientType: 'Monsternemers', spoed: false, photos: [{ id: 'p1', name: 'foto.jpg', data: 'data:image/jpeg;base64,abc' }],
  }],
  senderName: 'Sophie',
  senderPhone: '',
