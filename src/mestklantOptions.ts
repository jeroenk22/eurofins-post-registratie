...
export const MESTKLANT_OPTIONS: MestklantOption[] = [
  ...
  { label: 'DTech-KLEINE DOOS',         labelShort: 'DTech-KLEIN',           tms: 'Doosje sealrollen' },
  { label: 'DTech-GROTE DOOS',          labelShort: 'DTech-GROOT',           tms: 'Grote doos sealrollen (10 doosjes)' },
  { label: 'Vaste mestzakken (50st)',   labelShort: 'Vaste mestzkkn (50st)',  tms: 'Setje vaste mestzakken (50 stuks)' },
  { label: 'Vaste mestzakken (500st)',  labelShort: 'Vaste mestzkkn (500st)', tms: 'Grote doos vaste mestzakken (500 stuks)' },
]
